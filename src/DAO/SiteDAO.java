...
public class SiteDAO extends HibernateDaoSupport {
	...
	public Site findById(java.lang.Integer id) {
		...
		try {
			Site instance = (Site) getHibernateTemplate().get("DAO.Site", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public Site findBySitename(String sitename) {
		...
		buffer.append("from Site s where s.siteName='");
	 ...
	 * @param hql
	 */
	public List<Site> find(final String hql) throws Exception {
